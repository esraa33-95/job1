                ...
                <div class="card bg-light border-0">
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 col-10 position-relative overflow-hidden">
                            <img src="{{ asset('assets/img/' . $job->image) }}" alt="" class="card-img"
                                style="position: absolute; margin: auto; top: 50%; transform: translateY(-50%); object-fit: cover;" />
                        </div>
                        <div class="col-lg-8 col-md-6 col-12 card-body">
                            ...
                            <div class="mb-4">
                                <p class="card-text">
                                    <span class="fw-bold">salary_from:</span> {{ $job->salary_from }}
                                </p>
                            </div>
                            <div class="mb-4">
                                <p class="card-text">
                                    <span class="fw-bold">salary_to:</span> {{ $job->salary_to }}
                                </p>
                            </div>
                            <div class="mb-4">
                                <p class="card-text">
                                    <span class="fw-bold">qualification:</span> {{ $job->qualification }}
                                </p>
                            </div>
                            <div class="mb-4">
                                <p class="card-text">
                                    <span class="fw-bold">date line:</span> {{ $job->date_line }}
                                </p>
                            </div>
                            ...
                            <div class="mb-4">
                                <p class="card-text">
                                    <span class="fw-bold">Published:</span> {{ $job->published === 1 ? 'yes' : 'no' }}
                                </p>
                            </div>
                            <div class="mb-4">
                                <p class="card-text">
                                    <span
                                        class="fw-bold">Description:</span> {{ $job->description }}
                                </p>
                            </div>
