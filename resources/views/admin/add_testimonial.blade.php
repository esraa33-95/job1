            ...
            <div class="bg-light p-5 rounded">
                ...
                <form action="{{ route('test.store') }}" method="post" class="px-md-5" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col-md-10">
                            <textarea  class="form-control py-2" name="comment" cols="30" rows="5">{{ old('comment') }}</textarea>
                            @error('comment')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="profession" id="" cols="30" rows="5"
                                class="form-control py-2" value="{{ old('profession') }}">
                            @error('description')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
